  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="" class="logo" style="background-color: #cc3300;">
        ...
        <span class="logo-mini" style="background-color: #cc3300;"><b>Panel</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg" style="background-color: #cc3300;"><b>Panel</b> de Control</span>
      </a>
        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="./?p=agregar_producto">
              <i class="fa fa-th"></i> <span>Agregar Trabajador</span>
            </a>
          </li>
